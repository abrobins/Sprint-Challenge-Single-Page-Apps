...
- Client side routing offers smoother transitions between pages because the browser isn't making multiple calls to a server.
- This allows us to use things like state to instantly display information as opposed to having to constantly go to the server to load information/data.
